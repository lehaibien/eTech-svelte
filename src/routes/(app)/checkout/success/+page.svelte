...
<div class="container mx-auto flex flex-col justify-center items-center gap-2 px-8">
  ...
  <div class="w-2/3 text-lg text-center">
    <p>Chúng tôi đã gửi thông tin đơn hàng tới email của bạn. Đơn hàng sẽ sớm được xử lý.</p>
    <p>Bạn có thể tìm thêm thông tin trên trang web và trang mạng xã hội của chúng tôi.</p>
  </div>
